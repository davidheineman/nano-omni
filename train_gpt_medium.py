...
class Hyperparameters:
    # data
    train_files: str = "data/text/fineweb10B/fineweb_train_*.bin" # input .bin to train on
    val_files: str = "data/text/fineweb10B/fineweb_val_*.bin" # input .bin to eval validation loss on
